CREATE TABLE `school`.`studentdata` (`id` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(25) NOT NULL , `course` VARCHAR(25) NOT NULL , `fees_paid` INT NOT NULL , `status` VARCHAR(25) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
